...
#define FFMPEG_CONFIGURATION "--cc=/data/data/com.termux/files/home/android/android-ndk-r22/toolchains/llvm/prebuilt/linux-aarch64/bin/aarch64-linux-android21-clang --cxx=/data/data/com.termux/files/home/android/android-ndk-r22/toolchains/llvm/prebuilt/linux-aarch64/bin/aarch64-linux-android21-clang++ --arch=aarch64 --cpu=armv8-a --prefix=/data/data/com.termux/files/home/ffmpeg --disable-doc --disable-symver --disable-debug --enable-gpl --enable-small --enable-neon --enable-nonfree --enable-mediacodec --enable-decoder=h264_mediacodec --enable-pic --enable-jni --enable-cross-compile --target-os=android --cross-prefix=/data/data/com.termux/files/home/android/android-ndk-r22/toolchains/llvm/prebuilt/linux-aarch64/bin/aarch64-linux-android- --sysroot=/data/data/com.termux/files/home/android/android-ndk-r22/toolchains/llvm/prebuilt/linux-aarch64/sysroot --extra-cflags='-Os -fPIC -march=armv8-a' --enable-static --disable-shared --disable-asm"
...
#define CC_IDENT "Android (dev, based on r407598b) clang version 12.0.2 (https://android.googlesource.com/toolchain/llvm-project 91322a2ee9dd036d10e1529650dc3ee118dd26c0)"
